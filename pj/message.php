...
<script>
  ...
  <li class="active"><a href="message.php" style="text-align: center"><icon class="glyphicon glyphicon-envelope" style="width: 50px;"></icon></a></li>
...
?>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      ...
      <h3>If you did not find music that you searched you can just write name of that music and sent me. I will try find and ubload that music</h3>
      <div id="main">
      <form method="POST" action="message.php" role="form"><input type="name" style="width: 300px; height: 30px;" name="message"><br />
      <input type="submit" name="sent" value="Sent" style="margin-top: 5px;" <?php if ($num == 0) echo 'disabled="disabled"'?> /></form>
    </div>
<?php 
$con=mysqli_connect("localhost","root","","mysql"); 
...
$query=$con->query("INSERT INTO `message` (`id`,`message`) VALUES(null,'$message')");
} 
?>
